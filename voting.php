        ...
        <div class="container">
            ...
            <div class="poll-grid">
                ...
                <div class="poll-card" id="poll-bible">
                    ...
                    <div class="poll-options" id="bible-options">
                ...
                <div class="poll-card" id="poll-game">
                    ...
                    <div class="poll-options" id="game-options">
                        <!-- Options loaded via JS -->
                    </div>
                ...
                <div class="poll-card" id="poll-event">
                    ...
                    <div class="poll-options" id="event-options">
                        <!-- Options loaded via JS -->
                    </div>
